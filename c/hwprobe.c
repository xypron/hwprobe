...
int main()
{
	...
	struct ext_desc exts[] = {
		...
		{RISCV_HWPROBE_EXT_ZICNTR, "Zicntr", 1, 0x0006000f}, // 6.15
		{RISCV_HWPROBE_EXT_ZICOND, "Zicond", 1, 0},
		{RISCV_HWPROBE_EXT_ZIHINTPAUSE, "Zihintpause", 1, 0},
		{RISCV_HWPROBE_EXT_ZIHPM, "Zihpm", 1, 0x0006000f}, // 6.15
		...
		{RISCV_HWPROBE_EXT_ZAAMO, "Zaamo", 1, 0x0006000f}, // 6.15
		{RISCV_HWPROBE_EXT_ZALRSC, "Zalrsc", 1, 0x0006000f}, // 6.15
		{RISCV_HWPROBE_EXT_SUPM, "Supm", 1, 0x0006000d}, // 6.13
		{RISCV_HWPROBE_EXT_ZFBFMIN, "Zfbfmin", 0, 0},
		{RISCV_HWPROBE_EXT_ZVFBFMIN, "Zvfbfmin", 0, 0},
		{RISCV_HWPROBE_EXT_ZVFBFWMA, "Zvfbfwma", 0, 0},
		{RISCV_HWPROBE_EXT_ZICBOM, "Zicbom", 1, 0x0006000f}, // 6.15
